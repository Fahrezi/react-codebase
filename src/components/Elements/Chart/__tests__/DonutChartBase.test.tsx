...
import Donut from "../DonutChartBase";
...
describe("Donut Component", () => {
  it("should render a donut chart with the specified series and labels", async () => {
    const series = [10, 20, 30, 40];
    const labels = ["Label 1", "Label 2", "Label 3", "Label 4"];

    render(
      <ThemeProvider theme={legionTheme}>
        <Donut series={series} labels={labels} />
      </ThemeProvider>
    );
  ...
  it("should render a donut chart with custom chartProps", async () => {
    const series = [10, 20, 30, 40];
    const labels = ["Label 1", "Label 2", "Label 3", "Label 4"];
    ...
    render(
      <ThemeProvider theme={legionTheme}>
        <Donut series={series} labels={labels} chartProps={customChartProps} />
      </ThemeProvider>
    );
  ...
  it("should render a donut chart with donutLabels props", async () => {
    const series = [10, 20, 30, 40];
    const labels = ["Label 1", "Label 2", "Label 3", "Label 4"];
  ...
  it("should render a donut chart with custom yaxis for multiple axes", async () => {
    const series = [10, 20, 30, 40];
    const labels = ["Label 1", "Label 2", "Label 3", "Label 4"];
