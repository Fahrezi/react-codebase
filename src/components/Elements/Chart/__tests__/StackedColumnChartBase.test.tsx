...
import StackedColumnChartBase from "../StackedColumnChartBase";
...
describe("StackedColumnChartBase Component", () => {
  it("should render a stacked column chart with the specified series and labels", async () => {
    const series = [
    ...
    render(
      <ThemeProvider theme={legionTheme}>
        <StackedColumnChartBase series={series} labels={labels} />
      </ThemeProvider>
    );
  ...
  it("should render a stacked column chart with custom chartProps", async () => {
    const series = [
      { name: "Series 1", data: [10, 20, 30] },
      { name: "Series 2", data: [5, 15, 25] },
    ];
  ...
  it("should render a stacked column chart with custom plotOptions", async () => {
    const series = [
      { name: "Series 1", data: [10, 20, 30] },
      { name: "Series 2", data: [5, 15, 25] },
    ];
  ...
  it("should render a stacked column chart with custom yaxis for multiple axes", async () => {
